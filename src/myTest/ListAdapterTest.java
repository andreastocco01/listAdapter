...
public class ListAdapterTest
{
     ...
     * <strong>Preconditions</strong>: all the methods must work correctly.
     * <br><br>
     * <strong>Postconditions</strong>: modify the father list must produce unexpected results on the subList.
     * <br><br>
     * <strong>Expected result</strong>: the lists must contain the correct elements until the last case.
     * In that case an unexpected exception is thrown.
     */
    // teamList = {"Milan", "Liverpool", "Real Madrid", "Manchester United", "Bayern Monaco", "Ajax"}
    @Test
    public void testListAndIterator(){
        ...
        emptyList.addAll(teamList.subList(0, 3));
        teamList.removeAll(emptyList); // all "Milan" and "Liverpool" elements are removed
        assertArrayEquals(new Object[]{"Real Madrid", "Manchester United", "Bayern Monaco", "Ajax",
                "Real Madrid", "Real Madrid"}, teamList.toArray());
        /*
